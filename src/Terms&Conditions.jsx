      ...
      <Row className="justify-content-center">
        <Col md={10} className="tos-content">
          ...
          <div className="notice-box">
            <p>
              <strong>Important:</strong> By accessing or using Frame Rang's services, you agree to be bound by these terms. Please read them carefully.
            </p>
          </div>
          ...
          <section className="tos-section">
            ...
            <p>
              These Terms of Service ("Terms") govern your use of Frame Rang's website (framerang.com) and services for purchasing photo frames and posters. By placing an order, you agree to these Terms.
            </p>
          </section>
          ...
          <section className="tos-section">
            ...
            <p>
              Frame Rang shall not be liable for:
            </p>
            <ul>
