    ...
    <div className="privacy-policy-container">
      <Row>
        <Col md={12}>
          ...
          >
            <h1>Our Privacy Commitment at Frame Rang</h1>
            <p className="lead">
        ...
        <Col md={12}>
          ...
          >
            ...
            <div className="policy-content">
              <p>
                At Frame Rang, we believe in transparency. This policy explains in simple terms how we handle your personal information when you:
              </p>
              <ul>
